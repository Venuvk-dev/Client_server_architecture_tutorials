...
public class Server{
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("The server is listening on the port number of"+port);
            ...
            while(true){
                ...
                System.out.println("Client connected with the IP of :"+socket.getInetAddress());
                ...
                writer.println("Hello client we got your message "+message+ " , Thank you");
